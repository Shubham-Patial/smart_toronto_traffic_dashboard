...
# ---------------------------
st.set_page_config(
    page_title="Smart Toronto Traffic Dashboard",
    page_icon="🚦",
    layout="wide"
)
...
st.markdown("### By **Shubham Patial**")
st.markdown("""
This interactive dashboard analyzes **Toronto traffic collision data**, 
exploring how **weather, time, and location** impact road safety.  
